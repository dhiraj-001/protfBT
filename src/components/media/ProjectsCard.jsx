...
const ProjectsCard = ({ title, des, src }) => {
  return (
    <div className="w-full p-4 xl:px-12 h-auto xl:py-10 rounded-lg shadow-shadowOne flex align-middle flex-row group bg-[#c5aaf399] hover:bg-gradient-to-b hover:from-lime-50 hover:gray-900 transition-colors duration-1000">
