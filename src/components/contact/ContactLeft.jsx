...
const ContactLeft = () => {
  return (
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#a864b8] to-[#8558d2] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
      <img
      ...
      <div className="flex flex-col gap-4">
        <h3 className="text-3xl font-bold text-white">Bhumika Tewari</h3>
        <p className="text-lg font-normal text-[#14071b]">
